...
```mermaid
graph TD
    A[Student Protest for Human Rights] --> B{State Response}
    B --> C[Mass Detentions & Section 144]
    B --> D[Violation of Juvenile Justice Act]
    C --> E[Petition to the Supreme Court]
    D --> E
    E --> F[SC Orders Immediate Release of Minors]
    E --> G[SC Stays All Coercive Action]
    F --> H[Reinforcement of Child Rights]
    G --> I[Protection of Fundamental Free Speech]
    H --> J[Safeguarding Democratic Dissent]
    I --> J
```
