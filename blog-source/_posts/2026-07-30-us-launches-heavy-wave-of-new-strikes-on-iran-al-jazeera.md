...
```mermaid
graph TD
    A[US-Saudi Joint Strikes in Iraq] --> B[Iranian Ballistic Missiles hit Jordan]
    B --> C[US 'Heavy Wave' on Iranian Mainland]
    C --> D[Iranian Drone Attacks in Bahrain/Egypt]
    D --> E[US Naval Blockade of Hormuz]
    E --> A
