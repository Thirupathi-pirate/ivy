...
image:
  ...
  photographer: Emmanuel Phaeton
  photographer_url: https://unsplash.com/@emmanuelphaeton
  unsplash_url: https://unsplash.com/photos/love-scrabble-tiles-on-book-page-ZFIkUxRTWHk
---
...
```mermaid
graph TD
    A[Traditional Love] -->|Shift to Autonomy| B[Modern Love]
    B -->|Shift to Simulation| C[AI-Integrated Love]
    
    A -->|Values: Duty, Stability, Permanence| B
    B -->|Values: Satisfaction, Choice, Fluidity| C
    C -->|Values: Frictionless, Personalized, Immediate| D[The New Intimacy]
    
    D --> E{The Paradox}
    E -->|Positive| F[Reduced Loneliness]
    E -->|Negative| G[Loss of Human Social Skills]
```
