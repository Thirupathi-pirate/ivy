...
image:
  ...
  unsplash_url: https://unsplash.com/photos/a-computer-circuit-board-with-a-brain-on-it-_0iV9LmPDn0
---
...
<div class="post-hero">
  <img src="https://images.unsplash.com/photo-1711409664431-4e7914ac2370?ixid=M3w5ODUxMjJ8MHwxfHNlYXJjaHwyfHxOZXVyYWwlMjBJbnRlcmZhY2VzfGVufDB8MHx8fDE3ODI0ODkyODB8MA&ixlib=rb-4.1.0&fm=webp&w=780&h=440&fit=crop" alt="a computer generated image of a human brain" loading="lazy" width="780" height="440" data-unsplash-dl="https://api.unsplash.com/photos/ZnkHPagIOlM/download?ixid=M3w5ODUxMjJ8MHwxfHNlYXJjaHwyfHxOZXVyYWwlMjBJbnRlcmZhY2VzfGVufDB8MHx8fDE3ODI0ODkyODB8MA" />
  <div class="post-hero-credit">📸 <a href="https://unsplash.com/@whisperingshiba">Shawn Day</a> on <a href="https://unsplash.com/photos/a-computer-generated-image-of-a-human-brain-ZnkHPagIOlM">Unsplash</a></div>
</div>
...
```mermaid
graph TD
    A[Neural Interface Approaches] --> B[Invasive]
    A --> C[Minimally Invasive]
    A --> D[Non-Invasive]
    
    B --> B1[High Fidelity / High Risk]
    B --> B2[Example: Neuralink N1]
    
    C --> C1[Medium Fidelity / Low Risk]
    C --> C2[Example: Synchron Stentrode]
    
    D --> D1[Low Fidelity / No Risk]
    D --> D2[Example: EEG Headsets]
```
