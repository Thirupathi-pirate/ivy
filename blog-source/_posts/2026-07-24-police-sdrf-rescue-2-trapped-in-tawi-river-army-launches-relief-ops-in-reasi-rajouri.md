---
layout: post
title: "🌊 The Monsoon’s Fury and the Fight to Save Lives"
date: 2026-07-24 01:03:06 +0000
toc: true
mermaid: true
description: >-
  ```yaml
...
```mermaid
graph TD
    A[Natural Disaster: Flood/Landslide] --> B{Emergency Alert}
    B --> C[Jammu Police / District Admin]
    C --> D[SDRF: Technical Rescue]
    C --> E[Indian Army: Large Scale Relief]
    D --> F[Swift Water Rescue / Evacuation]
    E --> G[Infrastructure Restoration / Medical Aid]
    F --> H[Casualty Stabilization]
    G --> H[Community Recovery]
    H --> I[Return to Normalcy]
    C -.->|Coordination| D
    C -.->|Coordination| E
```
