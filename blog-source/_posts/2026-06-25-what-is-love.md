...
image:
  ...
  photographer_url: https://unsplash.com/@yoav
  unsplash_url: https://unsplash.com/photos/love-is-love-wall-art-with-brown-wooden-frame-_FlNNNDezuw
---
...
```mermaid
graph TD
    A[Early Childhood Bond] --> B{Attachment Style}
    B --> C[Secure]
    B --> D[Insecure]
    D --> E[Anxious]
    D --> F[Avoidant]
    C --> G[Healthy Adult Relationships]
    E --> H[Clinginess/Fear of Loss]
    F --> I[Emotional Distance/Walls]
    H --> J[Relationship Turbulence]
    I --> J
    G --> K[Long-term Stability]
    J --> L[Therapeutic Intervention/Healing]
    L --> G
```
