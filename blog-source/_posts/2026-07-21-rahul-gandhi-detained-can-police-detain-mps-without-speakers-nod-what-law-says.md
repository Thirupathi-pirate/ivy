---
layout: post
title: "🏛️ The \"Speaker’s Nod\" Myth: Can Police Actually Detain an MP?"
date: 2026-07-21 16:09:32 +0000
toc: true
mermaid: true
description: >-
  ```yaml
...
```mermaid
graph TD
    A[Intelligence/Police Report] --> B{Likelihood of Peace Breach?}
    B -- Yes --> C[Execute Preventive Detention]
    C --> D[Detention for 24-48 Hours]
    D --> E[Notification to Speaker/Authorities]
    E --> F[Review by Judicial Magistrate]
    B -- No --> G[Allow Movement/Protest]
    F -- Unjustified --> H[Release of Member]
    F -- Justified --> I[Continued Detention]
```
