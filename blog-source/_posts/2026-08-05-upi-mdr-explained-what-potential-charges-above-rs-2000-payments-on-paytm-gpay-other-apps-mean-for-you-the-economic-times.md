---
layout: post
title: "💸 Is the Era of Free UPI Ending? What the New MDR Rules Actually Mean for Your Wallet"
date: 2026-08-05 16:36:21 +0000
toc: true
mermaid: true
math: true
description: >-
  For years, "scanning and paying" in India has felt like a total win. Whether you're paying a street vendor ₹10 for a cutting chai or dropping ₹50,000 
image:
  path: "https://images.unsplash.com/photo-1511376698188-dd1b33bbca29?ixid=M3w5ODUxMjJ8MHwxfHNlYXJjaHwxfHxVUEklMjBNRFIlMjBleHBsYWluZWQlM0F8ZW58MHwwfHx8MTc4NTk0Nzc4MXww&ixlib=rb-4.1.0&fm=webp&w=1200&h=630&fit=crop"
  alt: "UP paint signage"
...
graph TD
    ...
    B -->|Bank-to-Bank| C[Standard UPI Rail]
    B -->|Digital Wallet| D[PPI Rail]
    
    C --> E[Merchant receives 100%]
    E --> F[Zero Fee Ecosystem]
    
    D --> G{Transaction > ₹2,000?}
    G -->|No| H[Merchant receives 100%]
    H --> F
    G -->|Yes| I[Merchant pays 1.1% MDR]
    I --> J[Fee Split: Bank / NPCI / TPAP]
    J --> F
```
