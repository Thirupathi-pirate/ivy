---
layout: post
title: "Shields Up, Tempers Down: How Delhi Police Kept the Peace During G20"
date: 2026-07-25 01:20:24 +0000
toc: true
mermaid: true
description: >-
  ```yaml
...
```mermaid
graph TD
    A[Crowd Gathering Detected] --> B{Strategy Selection}
    B -->|Traditional Model| C[Direct Confrontation]
    C --> D[Lathi Charge / Tear Gas]
    D --> E[Escalation & Viral Conflict]
    E --> F[Civil Unrest]
    B -->|Tactical Restraint| G[Multi-layered Containment]
    G --> H[Spatial Buffer / Cold Zones]
    H --> I[Digital Surveillance & Diversion]
    I --> J[De-escalated Resolution]
    J --> K[Peaceful Event Outcome]
```
