...
image:
  ...
  unsplash_url: https://unsplash.com/photos/person-holding-hello-sticker-SymZoeE8quA
---
...
<div class="post-hero">
  <img src="https://images.unsplash.com/photo-1644792863360-40fa85ea52e7?ixid=M3w5ODUxMjJ8MHwxfHNlYXJjaHwyfHxoZWxsbyUyMHdvcmxkfGVufDB8MHx8fDE3ODI0MDY2Mjl8MA&ixlib=rb-4.1.0&fm=webp&w=780&h=440&fit=crop" alt="a laptop computer sitting on top of a wooden desk" loading="lazy" width="780" height="440" data-unsplash-dl="https://api.unsplash.com/photos/8q6e5hu3Ilc/download?ixid=M3w5ODUxMjJ8MHwxfHNlYXJjaHwyfHxoZWxsbyUyMHdvcmxkfGVufDB8MHx8fDE3ODI0MDY2Mjl8MA" />
  <div class="post-hero-credit">📸 <a href="https://unsplash.com/@claybanks">Clay Banks</a> on <a href="https://unsplash.com/photos/a-laptop-computer-sitting-on-top-of-a-wooden-desk-8q6e5hu3Ilc">Unsplash</a></div>
</div>
...
```mermaid
graph TD
    A[User Intent] --> B[Specification Writer]
    B --> C{Execution Path}
    C -->|Classical| D[AI Coding Agent]
    C -->|Quantum| E[Quantum Circuit Designer]
    D --> F[Deterministic Output]
    E --> G[Probabilistic Distribution]
    F --> H[Unit Testing/Validation]
    G --> I[Statistical Analysis/Error Mitigation]
    H --> J[Final Application]
    I --> J
```
